...
<?php 
$sections_data=['Confessions'=>$confessions,'Complaints'=>$complaints,'Suggestions'=>$suggestions];
?>
...
<?php endforeach; ?>
<?php if(count($messages)>5): ?><button class="show-all-btn" onclick="showAll(this)">Show All</button><?php endif; ?>
</div>
</section>
<?php endforeach; ?>
</body>
