...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(!empty($msg) && array_key_exists($section, $valid_sections)) {
...
// Fetch messages for each section
...
<style>
body {
    background: url('<?= htmlspecialchars($bg_url) ?>') no-repeat center/cover;
}
</style>
</head>
<body>
...
<section>
    ...
    <div class="scroll-box">
        ...
        <div class="message-box <?= $i >= 5 ? 'hidden' : '' ?>">
            ...
            <small><?= htmlspecialchars($msg['submitted_at']) ?></small>
